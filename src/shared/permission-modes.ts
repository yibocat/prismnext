...
export type { PermissionRulesConfig } from "./smart-permission-policy";
export { buildPermissionRulesConfig, emptyPermissionRulesConfig } from "./smart-permission-policy";
