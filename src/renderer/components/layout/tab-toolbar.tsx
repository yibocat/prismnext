...
export const TabToolbar = memo(function TabToolbar({
  ...
  return (
    <div data-surface="content" className="flex h-[var(--height-right-area-subtoolbar)] min-w-0 shrink-0 items-center gap-0.5 overflow-hidden border-t border-[var(--toolbar-edge-line)] bg-background px-2 select-none text-[length:var(--font-size-12)] text-muted-foreground">
