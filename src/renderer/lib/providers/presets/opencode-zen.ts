...
export const opencodeZenPreset: ProviderConfig = {
  ...
  models: [
    { id: "claude-opus-4-8", name: "Claude Opus 4.8", contextWindow: "1M" },
    { id: "claude-sonnet-4-6", name: "Claude Sonnet 4.6", contextWindow: "1M" },
    { id: "claude-haiku-4-5", name: "Claude Haiku 4.5", contextWindow: "200K" },
    { id: "gpt-5.5-pro", name: "GPT-5.5 Pro", contextWindow: "1M" },
    { id: "gpt-5.5", name: "GPT-5.5", contextWindow: "1M" },
    { id: "gpt-5.4-pro", name: "GPT-5.4 Pro", contextWindow: "1M" },
    { id: "gpt-5.4", name: "GPT-5.4", contextWindow: "1M" },
    { id: "gpt-5.3-codex", name: "GPT-5.3 Codex", contextWindow: "1M" },
    { id: "gemini-3.5-flash", name: "Gemini 3.5 Flash", contextWindow: "2M" },
    { id: "gemini-3.1-pro", name: "Gemini 3.1 Pro", contextWindow: "2M" },
    ...
    { id: "qwen3.6-plus", name: "Qwen3.6 Plus", contextWindow: "256K" },
  ],
