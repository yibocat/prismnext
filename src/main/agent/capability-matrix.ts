...
export const HOST_RESEARCH_TOOLS: readonly ToolCapability[] = [
  ...
  { name: TOOL_NAMES.typstRoot, kind: "host_research", notes: "typst-root resolve" },
  { name: TOOL_NAMES.typstCompile, kind: "host_research", notes: "typst compile into .workbench/compile/typst" },
  { name: TOOL_NAMES.typstCompileStandalone, kind: "host_research", notes: "typst compile in-place standalone" },
