...
export const HOST_RESEARCH_TOOLS: readonly ToolCapability[] = [
  ...
  { name: TOOL_NAMES.latexCompile, kind: "host_research", notes: "compiler.ts under .workbench/compile/latex" },
  { name: TOOL_NAMES.latexCompileStandalone, kind: "host_research", notes: "compiler.ts in-place standalone .tex" },
  { name: TOOL_NAMES.typstCompile, kind: "host_research", notes: "typst build into .workbench/compile/typst" },
  { name: TOOL_NAMES.typstCompileStandalone, kind: "host_research", notes: "typst compile in-place standalone .typ" },
  ...
  { name: TOOL_NAMES.documentRead, kind: "host_research", notes: "AnyDoc local document-to-markdown" },
