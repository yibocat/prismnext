...
export const BUILTIN_TOOLS: BuiltinToolMeta[] = [
  ...
  },
  {
    ...
    workflowRules: [
      ...
      "Allowed kinds: figure.plotly, instrument, figure.static, plot.line, plot.series, plot.scatter. scene.ir/math.surface/math.field/scene.program are retired — writes rejected, old artifacts read-only.",
