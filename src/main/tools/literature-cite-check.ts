/**
 * literature-cite-check — Compare \\cite keys in .tex against project literature library bibkeys.
 */
...
export default tool({
  description:
    ...
    "Prefer over read/glob when checking citation compliance; returns missingKeys, unusedKeys, bibFallback JSON.",
  args: {},
  async execute(_args, context) {
    return bridgeCall(context as Record<string, unknown>, { action: "cite-check" });
  },
});
