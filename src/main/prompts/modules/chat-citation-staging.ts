...
export const CHAT_CITATION_STAGING_PROMPT = [
  ...
  "",
  "- Paper Search MCP `search_papers` **only discovers** identifiers — it does **not** create Prism Next session citations.",
  ...
  "- Prism Next appends **Session citations (this chat)** to the Task result automatically — still write `[n]` in your summary so the orchestrator can read it inline.",
  "",
