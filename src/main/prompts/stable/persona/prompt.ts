/** Research AI assistant persona
 * Segment: stableSystem 1.1
 * Answers: role, mission, authorship boundary, refusals
 * Not here: product shell (Host), local-first / chat-vs-disk, scholarly reasoning,
 *   reply length, edit tactics, folder layout, domain routing
