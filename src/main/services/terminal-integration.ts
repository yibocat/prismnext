...
const ZSH_RC = `# Prism terminal shell integration (OSC 133)
...
const BASH_RC = `# Prism terminal shell integration (OSC 133)
...
function ensureIntegrationFiles(): string {
  const base = join(app.getPath("userData"), "terminal-integration");
