(() => {
  const STRINGS = {
    en: {
      ...
      skillsText:
        "29 bundled skills the agent is held to — each with reference tables, templates, and runnable scripts. Always-on discipline lives in the prompt layer; skills load on demand. Open format: plug in community sources or distill your own from practice.",
      ...
      skObservable: "Density, hexbin, facets, geo views — manuscript-grade SVG from spec + CSV.",
      skSymMath: "SymPy-verified derivations, straight to LaTeX.",
      skMathNumeric: "Seeded probes, convergence orders, worst-case errors — PASS/FAIL exit.",
      skManifold: "Connections, curvature, geodesics, holonomy, gauge — symbolic + numeric checks.",
      skLattice: "Gröbner-basis membership, LLL equivalence, number fields — PASS/FAIL.",
    ...
    zh: {
      ...
      skillsTitle: "内置的科研规范",
      skillsText:
        "Agent 须遵守的 29 个内置技能——每个都配参考表、模板与可运行脚本。每轮必守的纪律在常开 prompt 层，技能按需加载。格式开放：可接社区技能源，也可把刚走通的流程蒸馏成你自己的。",
      skillTierDesign: "构想、设计与运行 · 7",
      skillTierWriting: "写作 · 7",
      skillTierFigures: "图表 · 5",
      skillTierReview: "阅读与评审 · 5",
      skillTierMeta: "数学与元 · 5",
      ...
      skObservable: "密度、hexbin、分面、地理视图——spec + CSV 直出论文级 SVG。",
      skSymMath: "SymPy 验证的符号推导，直达 LaTeX。",
      skMathNumeric: "种子化探针、收敛阶、最坏误差——PASS/FAIL 退出码。",
      skManifold: "联络、曲率、测地线、和乐、规范——符号演算加数值探针。",
      skLattice: "Gröbner 基成员判定、LLL 等价、代数数域——PASS/FAIL。",
      ...
      skNameSympy: "符号推导",
      skNameMathNumeric: "数值验证",
      skNameManifold: "流形与几何",
      skNameLattice: "格与代数",
