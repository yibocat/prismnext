(() => {
  const STRINGS = {
    en: {
      ...
      figHome: "The session composer — model, expert, and skills at hand.",
      ...
      mn4: "five packs, one desk",
      mn5: "fork it on GitHub →",
      mn6: "figures wear the current pack →",
      appearanceTitle: "Themes & appearance",
      appearanceLede:
        "This site wears the same five theme packs as the app — switch packs and desk backdrops from the header. Drag to compare light and dark of your current pack.",
      compareLight: "Light",
      compareDark: "Dark",
      figCompare: "Light and dark of the current pack — drag the divider.",
    ...
    zh: {
      ...
      appearanceLede: "本站与应用共用五套主题包——在顶栏切换主题包，顶栏菜单里也能换背景样式。拖动对比当前主题包的亮与暗。",
      compareLight: "浅色",
      compareDark: "深色",
      figCompare: "当前主题包的亮与暗——拖动分割线。",
