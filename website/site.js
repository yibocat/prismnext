(() => {
  const STRINGS = {
    en: {
      ...
      skillTierOrch: "Orchestration · 10",
      skillTierMethod: "Method & rigor · 6",
      skillTierDiscipline: "Discipline protocols · 2",
      skillTierMeta: "Meta · 1",
      skKickoff: "Idea → structured project: brief, plan, skeleton.",
      skRelatedWork: "Discover → screen → stage → cite, on the literature tools.",
      skReadingNotes: "Structured deep-read notes from PDFs.",
      skHypothesis: "Sharpen a question into testable hypotheses.",
      skDesignMatrix: "Fix the factorial / ablation matrix before running.",
      skToMethods: "Experiment logs become Methods prose.",
      skFigurePipeline: "Data → figure → manuscript, end to end.",
      skCriticalReview: "Claims-vs-evidence structured self-critique.",
      ...
      skSkillCreator: "Author and validate your own skills.",
      skNameKickoff: "Project kickoff",
      skNameRelated: "Related-work pipeline",
      ...
      skNameReview: "Critical self-review",
      ...
      skNameVis: "Scientific visualization",
    ...
    zh: {
      ...
      skillsTitle: "内置的科研规范",
      skillsText:
        "Agent 须遵守的科研规范——每条都配参考表、模板与可运行脚本。格式开放：可接社区技能源，也可以写你自己的。",
      skillTierOrch: "闭环编排 · 10",
      skillTierMethod: "方法规范 · 6",
      skillTierDiscipline: "学科协议 · 2",
      skillTierMeta: "元 · 1",
      skKickoff: "研究想法 → 项目：brief、计划、目录骨架。",
      skRelatedWork: "发现 → 筛选 → 暂存 → 引用，接文献工具链。",
      skReadingNotes: "从 PDF 产出结构化精读笔记。",
      skHypothesis: "把问题磨成可检验的假设。",
      skDesignMatrix: "跑实验前先定全因子 / 消融矩阵。",
      skToMethods: "实验日志变成 Methods 正文。",
      skFigurePipeline: "数据 → 图 → 手稿，端到端。",
      skCriticalReview: "主张 vs 证据的结构化自审。",
      skRebuttal: "逐点回复审稿意见。",
      ...
      skSkillCreator: "创作并校验你自己的技能。",
      skNameKickoff: "项目启动",
      skNameRelated: "相关工作流水线",
      skNameNotes: "精读笔记",
